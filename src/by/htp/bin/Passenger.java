...
public class Passenger implements Serializable {
	...
	public Passenger(int age, String name, String surname, String middleName, String dateOfBirth, String passportId, String sex, 
			Date passportExpirty, Baggage baggage) {
		super();
		this.age = age;
		this.name = name;
	...
	public Date getPassportExpirty() {
		return passportExpirty;
	}

	public void setPassportExpirty(Date passportExpirty) {
		this.passportExpirty = passportExpirty;
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((passportExpirty == null) ? 0 : passportExpirty.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (passengerId != other.passengerId)
			return false;
		if (passportExpirty == null) {
			if (other.passportExpirty != null)
				return false;
		} else if (!passportExpirty.equals(other.passportExpirty))
			return false;
		if (passportId == null) {
	...
	public String toString() {
		return "Passenger [passengerId=" + passengerId + ", age=" + age + ", name=" + name + ", surname=" + surname
				...
				+ ", sex=" + sex + ", passportExpirty=" + passportExpirty + ", baggage=" + baggage + "]";
	}
