...
//	public static final String ACTION_FLIGHT_CANCEL = "cancel_flight";
	...
	public static final String SQL_STATEMENT_USER_NAME = "select user_name, user_surname, role , user.user_id from user join logon_data on user.user_id = logon_data.user_id where logon_data.login=? and logon_data.password=?;";
	...
	public static final String SQL_STATEMENT_CREATE_TICKET = "INSERT INTO ticket (flight_id, passenger_id, primary_boarding, online_checkin, total_amount) VALUES (?, ?, ?, ?, ?);";
	public static final String SQL_STATEMENT_CREATE_TICKET_LIST ="INSERT INTO ticket_list (ticket_list_id, ticket_id, user_id) VALUES (?,?,?);";
	public static final String SQL_STATEMENT_CREATE_TICKET_IF_TICKETLIST_EXISTS="select count(*) from ticket_list where user_id=?";
	public static final String SQL_STATEMENT_CREATE_TICKET_UPDATE_USER=" UPDATE user SET ticket_list_id=? WHERE  user_id=?;";
	public static final String SQL_STATEMENT_CREATE_TICKET_SEARCH_TICKET_LIST=" select ticket_list_id from ticket_list where user_id=?";
	public static final String SQL_STATEMENT_CREATE_TICKET_MAX_LIST="select MAX(ticket_list_id) from ticket_list";
	//change FLIGHT date & time data
	public static final String SQL_STATEMENT_CHANGE_FLIGHT_DATA="UPDATE flight SET departure_date=?, departure_time=?, arrival_date=?, arrival_time=? WHERE  flight_id=?;";
	public static final String SQL_STATEMENT_CANCEL_FLIGHT="UPDATE flight SET cancellation='cancelled' WHERE  flight_id=?;";
