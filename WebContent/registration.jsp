...
<!-- Start Formoid form-->
      <!--<link rel="stylesheet" href="formoid_files/formoid1/formoid-solid-red.css" type="text/css" />-->
        ...
        <form class="formoid-solid-red" style="background-color:#FFFFFF;font-size:15px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px" method="GET" action = "Main" id="create_user">
        <input type="hidden" name="action" value="create_user">
          ...
          <div class="element-input">
            ...
            <div class="item-cont">
              <input class="large" type="text" name="create_login" required="required" placeholder="Login"/>
            ...
            <div class="element-password">
              ...
              <div class="item-cont">
                <input class="large" type="password" name="create_password" value="" required="required" placeholder="Password"/>
                <!--<span class="icon-place"></span>-->
              </div>
            </div>
            <div class="element-password">
              ...
              <div class="item-cont">
                <input class="large" type="password" name="create_password1" value="" placeholder="Password confirm"/>
               <!-- <span class="icon-place"></span>-->
              </div>
            </div>
            ...
            <div class="element-email">
              ...
              <div class="item-cont">
                <input class="large" type="email" name="create_email" value="" required="required" placeholder="Email"/>
                <!--<span class="icon-place"></span>-->
              </div>
            </div>
          <div class="submit">
